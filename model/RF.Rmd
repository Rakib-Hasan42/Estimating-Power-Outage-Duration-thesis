...
ggplot(plot_df, aes(x = actuals, y = preds)) +
  ...
  labs(
    title = "Actual vs Predicted with Regression Line (20% random split)",
    x = "Actual Outage",
    y = "Predicted Outage",
    color = "Legend"
  ) +
...
ggplot(plot_df, aes(x = actuals, y = preds)) +
  ...
  scale_y_continuous(labels = label_comma()) +
  labs(
    title = "Actual vs Predicted with Regression Line (Idalia)",
    x = "Actual Outage",
    y = "Predicted Outage",
    color = "Legend"
  ) +
...
ggplot(plot_df, aes(x = actuals, y = preds)) +
  ...
  scale_y_continuous(labels = label_comma()) +
  labs(
    title = "Actual vs Predicted with Regression Line (Ian)",
    x = "Actual Outage",
    y = "Predicted Outage",
    color = "Legend"
  ) +
...
ggplot(plot_df, aes(x = actuals, y = preds)) +
  ...
  scale_y_continuous(labels = label_comma()) +
  labs(
    title = "Actual vs Predicted with Regression Line (Nicole)",
    x = "Actual Outage",
    y = "Predicted Outage",
    color = "Legend"
  ) +
...
ggplot(plot_df, aes(x = actuals, y = preds)) +
  ...
  scale_y_continuous(labels = label_comma()) +
  labs(
    title = "Actual vs Predicted with Regression Line (Sally)",
    x = "Actual Outage",
    y = "Predicted Outage",
    color = "Legend"
  ) +
...
ggplot(plot_df, aes(x = actuals, y = preds)) +
  ...
  scale_y_continuous(labels = label_comma()) +
  labs(
    title = "Actual vs Predicted with Regression Line (Eta)",
    x = "Actual Outage",
    y = "Predicted Outage",
    color = "Legend"
  ) +
...
ggplot(plot_df, aes(x = actuals, y = preds)) +
  ...
  scale_y_continuous(labels = label_comma()) +
  labs(
    title = "Actual vs Predicted with Regression Line (Elsa)",
    x = "Actual Outage",
    y = "Predicted Outage",
    color = "Legend"
  ) +
...
ggplot(plot_df, aes(x = actuals, y = preds)) +
  ...
  scale_y_continuous(labels = label_comma()) +
  labs(
    title = "Actual vs Predicted with Regression Line (Mindy)",
    x = "Actual Outage",
    y = "Predicted Outage",
    color = "Legend"
  ) +
...
ggplot(plot_df, aes(x = actuals, y = preds)) +
  ...
  scale_y_continuous(labels = label_comma()) +
  labs(
    title = "Actual vs Predicted with Regression Line (Fred)",
    x = "Actual Outage",
    y = "Predicted Outage",
    color = "Legend"
  ) +
